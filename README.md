...
**Free Turn Proxy** - прокси-туннель для инкапсуляции UDP-трафика поверх протокола TURN. Клиент извлекает временные TURN-учётки из ссылок на WebRTC-звонки и прозрачно маршрутизирует ваш VPN-трафик (WireGuard, AmneziaWG) до сервера на VPS, используя DTLS и мощные механизмы маскировки пакетов.
